<?php
	...
	$sql = "SELECT p_id, p_name, c_name, p_details, p_price, p_quantity, p_image FROM tbl_product, tbl_category WHERE tbl_product.c_id = tbl_category.c_id AND tbl_category.c_name = '$_category'";
	$result = $db->query($sql);
